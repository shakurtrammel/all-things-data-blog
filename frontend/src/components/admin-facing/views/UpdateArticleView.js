...
// Main component.
class UpdateArticleView extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            isLoading: true,
        ...
        if (error)
            ...
            return (
                <PageWrapper>
                    ...
                    <AdminHeader />
                    <MainContainer>
                    <StyledForm method='PUT'>
                            <TitleWrapper>
                                <label htmlFor='title'>Title: </label>
                                <input type='text' name='title' cols='45' placeholder={article[0].title} onChange={this.handleInputChange}></input>
                            </TitleWrapper>
                                    ...
                                    init= {{
                                            ...
                                            setup: function (editor) {
                                                editor.on('init', function (e) {
                                                    editor.setContent(article[0].intro)
                                                })
                                            }
                                        }}
                                />
                            ...
                            <PointWrapper id='point1'>
                                ...
                                <input type='text' name='p1_heading' placeholder={article[0].p1_heading} onChange={this.handleInputChange}></input>
                                <Editor
                                    id='p1'
                                    apiKey='bbn2g27vv6w704mygy8k29ttnfoh7f907dblbwalmf6rqgn4'
                                    initialValue={this.props.initialValue}
                                    ...
                                    init= {{
                                            ...
                                            setup: function (editor) {
                                                editor.on('init', function (e) {
                                                    editor.setContent(article[0].p1)
                                                })
                                            }
                                        }}
                                />
                            ...
                            <PointWrapper id='point2'>
                                ...
                                <input type='text' name='p2_heading' placeholder={article[0].p2_heading} onChange={this.handleInputChange}></input>
                                <Editor
                                    id='p2'
                                    apiKey='bbn2g27vv6w704mygy8k29ttnfoh7f907dblbwalmf6rqgn4'
                                    initialValue={this.props.initialValue}
                            ...
                            <PointWrapper id='point3'>
                                ...
                                <input type='text' name='p3_heading' placeholder={article[0].p3_heading} onChange={this.handleInputChange}></input>
                                <Editor
                                    id='p3'
                                    apiKey='bbn2g27vv6w704mygy8k29ttnfoh7f907dblbwalmf6rqgn4'
                                    initialValue={this.props.initialValue}
